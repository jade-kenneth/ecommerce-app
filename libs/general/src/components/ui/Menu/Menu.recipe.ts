...
export const menuRecipe = tv({
  slots: anatomyToRecipeSlots(menuAnatomy, {
    content:
      'z-dropdown min-w-[215px] rounded-lg border border-[#EAECF0] bg-white p-1 dark:border-[#26272B] dark:bg-[#0A1117] outline-none',
    ...
    trigger: 'hover:cursor-pointer outline-none',
  }),
});
