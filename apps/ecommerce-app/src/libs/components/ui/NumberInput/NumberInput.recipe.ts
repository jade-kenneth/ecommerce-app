...
export const numberInputRecipe = tv({
  slots: anatomyToRecipeSlots(numberInputAnatomy, {
    ...
    input:
      'rounded-[32px] border-[1px] border-[#EAEAEA] outline-none placeholder:text-carbon-700 py-3 px-4 ui-invalid:border-[#D92D20]',
    label:
      'mb-1.5 flex items-center gap-1.5 text-carbon-100 text-sm font-bold dark:text-[#F5F5F6]',
    decrementTrigger:
